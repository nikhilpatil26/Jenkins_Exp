...
Home Page UI Elements Validation
    ...
    FOR  ${Banner}  IN  @{True5G_Banner}
        Wait For And Verify Element        ${Banner}
    END
    ...
    #Three product cards
    ${Products_Cards}=    Get WebElements        xpath=//div[contains(@class," cursor-pointer shadow-vertical-mg")]
    ${Products_Count}  Set Variable   0                      
    FOR  ${Products_Section}  IN  @{Products_Cards}
        #Wheel Down      1
        Section Verification               ${Product_Section}     Products_${Products_Count}
