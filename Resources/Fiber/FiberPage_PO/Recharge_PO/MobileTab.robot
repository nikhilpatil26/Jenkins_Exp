...
Click on Mobile tab
    ...
    Wait For And Input Text                        xpath: //input[@id="submitNumber"]    ${Mobile_No}
    
    #Click on Continue
    Redirect and continue                          xpath: //button[@aria-label="button Continue"]    https://www.jio.com/selfcare/recharge/mobility/plans/?serviceId=${Mobile_No}&serviceType=mobility&next=PREPAID&billingType=POSTPAID    Sc_SelectPlanPage
...
Verify UI elements and accordian functionality of Select plan and View details page mobile tab
    ...
    Wait For And Verify Element                    xpath: //div[@class="field-group"]//input[@value=${Mobile_No}]
    ...
    Redirect and continue                         xpath: //button[@class="css-r5gb33"]     https://www.jio.com/selfcare/recharge/mobility/plans/?serviceId=${Mobile_No}&serviceType=mobility&next=PREPAID&billingType=POSTPAID     Sc_paymentsgateway
    Go To                                         https://www.jio.com/selfcare/recharge/mobility/plans/?serviceId=${Mobile_No}&serviceType=mobility&next=PREPAID&billingType=POSTPAID
...
Verify UI and Content elements of ISD tab
    ...
    Redirection On Clicking                        xpath://button[normalize-space()='Edit']    https://www.jio.com/selfcare/recharge/mobility/?serviceId=${Mobile_No}&serviceType=mobility&next=PREPAID&billingType=POSTPAID&action=edit    Sc_Editbuttonredirection
