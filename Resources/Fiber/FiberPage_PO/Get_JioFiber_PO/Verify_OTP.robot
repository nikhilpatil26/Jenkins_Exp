...
Verify Redirection of Verify OTP page
    ...
    Wait For And Input Text               xpath://input[@id="submitMobile"]    ${Mobile_No}
...
Verify UI of Verify OTP page
    ...
    Wait For And Verify Element           xpath://div[text()="${Mobile_No}"]
    
    # Verifying if the number is same as number entered
    Text Verification                     xpath://div[text()="${Mobile_No}"]        ${Mobile_No}
