...
Enter Pin Code
    ...
    #Entering PinCode
    Wait For And Input Text    id:address.postcode    ${PinCode}
...
Personal Details Page Validation
    ...
    Wait For And Verify Element    (//div[@class="item_container_holder"]/div)[3] 
    CSS Verification    (//div[@class="item_container_holder"]/div)[3]    color    rgba(202, 202, 202, 1)
    Wait For And Verify Element    (//div[@class="item_container_holder"]/div)[4]
    CSS Verification    (//div[@class="item_container_holder"]/div)[4]    color    rgba(202, 202, 202, 1)
...
UI Validation of Delivery Address Page
    ...
    Should Be Equal As Strings    ${Fetching_Pincode}    ${Pincode}    Pincode Found    
...
Landing on Installation address page                # Vishal Hassani
    ...
    Wait For And Input Text           xpath://input[@id="submitMobile"]    ${Mobile_No2}
