...
Mobile View Details Section Validation
    ViewDetailsPage_UI.Validating UI and Redirection on View Details Section       ${Mobile_No}    Mobile_Recharge      https://www.jio.com/selfcare/recharge/mobility/plans/?serviceId=${Mobile_No}&serviceType=mobility&next=PREPAID&billingType=PREPAID      https://www.jio.com/selfcare/recharge/mobility/?serviceId=${Mobile_No}&serviceType=mobility&next=PREPAID&billingType=PREPAID&action=edit
