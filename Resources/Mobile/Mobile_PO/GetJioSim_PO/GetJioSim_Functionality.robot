...
Get JioSim Page Verification
    ...
    Enter Number and Proceed                xpath=//div[contains(@class,'input-tel')]//input   ${Mobile_No}  xpath=//button[@aria-label='button Generate OTP']
...
Verify Switching Between Tabs
    ...
    ${Pin_code}=        Get Text            xpath=//input[@type='tel']
    Text Verification                       xpath=//input[@type='tel']               ${Pin_code}
