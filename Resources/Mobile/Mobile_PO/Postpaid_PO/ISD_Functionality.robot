...
Verify and Validate Plan Cards and Recharge Redirection of ISD Plans
    ...
    Recharge Popup Verification                xpath=(//section[contains(@class,'desktop')]//div[normalize-space()='Recharge'])[2]         xpath=(//div[@class='j-text j-text-heading-m'])[3]  No View Details     ${RURL}    ${Mobile_No}
    ...
    Recharge Popup Verification                xpath=(//button[@aria-label='button'][normalize-space()='Buy'])[3]     xpath=(//div[@class='j-text j-text-heading-m'])[3]   xpath=(//button[@aria-label='button'][normalize-space()='View details'])[3]     ${RURL}    ${Mobile_No}
