...
Verify and Validate Plan Cards and Recharge Redirection of All Popular Plans
    ...
    FOR     ${j}    IN RANGE   1  ${length}
        ...
        common.Recharge Popup Verification      xpath=(//button//div[contains(text(),'Recharge')])[${j}]     xpath=(//*[contains(@class,"desktop")]//*[contains(@class,"PlanName_planText")])[${j}]      xpath=(//button//div[contains(text(),'View details')])[${j}]        ${RURL}    ${Mobile_No2}
