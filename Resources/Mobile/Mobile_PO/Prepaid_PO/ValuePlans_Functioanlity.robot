...
Verify and Validate Plan Cards and Recharge Redirection of Value Plans
    ...
    FOR     ${j}    IN RANGE   1  ${length}+1
        ...
        # Verifying Recharge Pop-up
        common.Recharge Popup Verification                       xpath=(//div[contains(@class,'visible')]//button[normalize-space()='Recharge'])  xpath=(//div[contains(@class,'visible')]//div[contains(@class,'PlanName')])   xpath=(//section[contains(@class,'desktop')]//button[normalize-space()='View details'])[${j}]  ${RURL}    ${Mobile_No2}
    END
