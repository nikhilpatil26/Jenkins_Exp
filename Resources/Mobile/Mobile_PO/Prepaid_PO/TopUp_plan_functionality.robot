...
Verify and Validate Plan Cards and Recharge Redirection of Top-up Plans
    ...
    FOR     ${j}    IN RANGE   1  ${length_topup}+1
        ...
        common.Recharge Popup Verification      xpath=(//button//div[contains(text(),'Recharge')])[${j}]     xpath=(//section[contains(@class,'desktop')]//div[contains(@class,"PlanName_planText")])[${j}]      xpath=(//button//div[contains(text(),'View details')])[${j}]        ${RURL}    ${Mobile_No2} # PrePaid Number should have valid recharge
