...
Confirm UI & Content of Choose plans pop-up for Mobile
    ...
    Enter Number and Proceed                    xpath=//input[@id='quick-recharge-user-number']      ${Mobile_No}    xpath=//button[contains(@class,'btn-disabled')] 
    ...
    Text Verification                           xpath=//div[@class='j-contentBlock__description j-text-body-xs-bold']    Recharge plans for ${Mobile_No}
...
PayBill Popup Validation
    ...
    #Mobile Tab
    Paybill Tab Validation-Mobile               ${Mobile_No}
