...
Get Jio SIM PopUp Content Validate
    ...
    Check Buttons Enabled                       xpath=//input[@id='user-name']      ${Name}     xpath=//input[@id='user-number']    ${Mobile_No}  xpath=//button[@id='generateOTP-btn']
    Sleep  100ms
...
Verify phone number popup content validate
    ...
    #Subtext
    Text Verification                           xpath=//div[@id='maskedMob']        Enter the OTP sent to your mobile number ${Mobile_No}
